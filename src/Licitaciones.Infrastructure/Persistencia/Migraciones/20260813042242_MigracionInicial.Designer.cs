...
namespace Licitaciones.Infrastructure.Persistencia.Migraciones
{
    ...
    [Migration("20260813042242_MigracionInicial")]
            ...
            modelBuilder.Entity("Licitaciones.Domain.Aprobaciones.NivelAprobacion", b =>
                {
                    ...
                    b.ToTable("niveles_aprobacion", null, t =>
                        {
                            t.HasCheckConstraint("ck_niveles_minimo_positivo", "\"MontoMinimoCRC\" > 0");

                            t.HasCheckConstraint("ck_niveles_rango_coherente", "\"MontoMaximoCRC\" IS NULL OR \"MontoMaximoCRC\" > \"MontoMinimoCRC\"");
                        });
                });
            ...
            modelBuilder.Entity("Licitaciones.Domain.TiposCambio.TipoCambio", b =>
                {
                    ...
                    b.ToTable("tipos_cambio", null, t =>
                        {
                            t.HasCheckConstraint("ck_tipos_cambio_positivo", "\"CRCporUSD\" > 0");
                        });
                });

            modelBuilder.Entity("Licitaciones.Domain.Ofertas.Oferta", b =>
                {
                    b.HasOne("Licitaciones.Domain.Licitaciones.Licitacion", "Licitacion")
                        .WithMany("Ofertas")
                        .HasForeignKey("LicitacionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Licitaciones.Domain.Proveedores.Proveedor", "Proveedor")
                        .WithMany("Ofertas")
